...
<!-- Mirrored from foxythemes.net/preview/products/maisonnette/pages-profile.php?theme=blue-sky by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jun 2018 02:55:54 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Profile | Einsteinbet</title>
                    ...
                    <nav class="navbar navbar-expand-md">
                      ...
                      <div id="mai-navbar-collapse" class="navbar-collapse collapse mai-nav-tabs">
                        <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item parent open"><a href="#" role="button" aria-expanded="false" class="nav-link"><span class="icon s7-portfolio"></span><span>Pages</span></a>
                                      <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                                                  <li class="nav-item"><a href="pages-profile.html" class="nav-link active"><span class="icon s7-user"></span><span class="name">Profile</span></a>
                                                  </li>
            ...
            <div class="col-md-12">
              <div class="user-display">
                ...
                <div class="user-display-bottom">
                  <div class="user-display-id"><img src="assets/img/avatars/img3.jpg" alt="avatar" class="user-display-avatar">
            ...
            <ul class="timeline">
              <li class="timeline-item">
                ...
                <div class="timeline-content">
                  <div class="timeline-avatar"><img src="assets/img/avatars/img1.jpg" alt="Avatar" class="circle"></div>
              ...
              <li class="timeline-item timeline-item-detailed">
                ...
                <div class="timeline-content">
                  <div class="timeline-avatar"><img src="assets/img/avatars/img2.jpg" alt="Avatar" class="circle"></div>
              ...
              <li class="timeline-item timeline-item-detailed timeline-item-gallery">
                ...
                <div class="timeline-content">
                  <div class="timeline-avatar"><img src="assets/img/avatars/img3.jpg" alt="Avatar" class="circle"></div>
                  <div class="timeline-header"><span class="timeline-time">10:42 AM</span><span class="timeline-autor">Justin Adams </span>
                    ...
                    <div class="timeline-gallery"><img src="assets/img/gallery/img2.jpg" alt="Thumbnail" class="gallery-thumbnail"><img src="assets/img/gallery/img4.jpg" alt="Thumbnail" class="gallery-thumbnail"><img src="assets/img/gallery/img11.jpg" alt="Thumbnail" class="gallery-thumbnail"></div>
                  </div>
                </div>
              </li>
              <li class="timeline-item timeline-item-detailed">
              ...
              <li class="timeline-item">
                ...
                <div class="timeline-content">
                  <div class="timeline-avatar"><img src="assets/img/avatar.jpg" alt="Avatar" class="circle"></div>
              ...
              <li class="timeline-item timeline-loadmore"><a href="#" class="btn btn-sm btn-secondary load-more-btn">Load more</a></li>
            </ul>
          </div>
        </div>
      </div>
