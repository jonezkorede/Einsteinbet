...
<!-- Mirrored from foxythemes.net/preview/products/maisonnette/ui-notifications.php?theme=blue-sky by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jun 2018 02:56:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Einsteinbet">
    <meta name="author" content="">
    <link rel="shortcut icon" href="assets/img/favicon.html">
    <title>Notifications | Einsteinbet</title>
    ...
    <link rel="stylesheet" type="text/css" href="assets/lib/font-awesome/css/font-awesome.min.css"/><link type="text/css" href="assets/css/themes/blue-sky.css" rel="stylesheet">  </head>
  <body>
                                    ...
                                    <li class="nav-item parent open"><a href="#" role="button" aria-expanded="false" class="nav-link"><span class="icon s7-home"></span><span>Home</span></a>
                                      <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                                                  ...
                                                  <li class="nav-item dropdown parent"><a href="plugins.html" data-toggle="dropdown" class="nav-link"><span class="icon s7-plugin"></span><span class="name">Plugins</span></a>
                                                              <div role="menu" class="dropdown-menu mai-sub-nav"><a href="ui-modals.html" class="dropdown-item">Modals</a><a href="ui-nestable-lists.html" class="dropdown-item">Nestable Lists</a><a href="ui-notifications.html" class="dropdown-item active">Notifications</a>
                                                              </div>
                                                  </li>
                                      </ul>
                                    </li>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="panel panel-default">
              <div class="panel-heading panel-heading-divider">Notifications<span class="panel-subtitle">Default Gritter notifications styles</span></div>
              <div class="panel-body">
                ...
                <p class="xs-mt-30 xs-mb-20 text-center">
                  <button id="not-basic" type="button" class="btn btn-space btn-secondary"> Basic</button>
            ...
            <div class="panel panel-default">
              <div class="panel-heading panel-heading-divider">Social<span class="panel-subtitle">Gritter notifications with different social networks colors</span></div>
              <div class="panel-body">
                <p>You can choose between use the basic, gritter Notification style or our theme based notification, just have fun with them.</p>
                <p class="xs-mt-30 xs-mb-20 text-center">
                  <button id="not-facebook" type="button" class="btn btn-space btn-social btn-facebook btn-color">Facebook</button>
                  <button id="not-twitter" type="button" class="btn btn-space btn-social btn-twitter btn-color">Twitter</button>
                  <button id="not-google-plus" type="button" class="btn btn-space btn-social btn-google-plus btn-color">Google+</button>
                  <button id="not-dribbble" type="button" class="btn btn-space btn-social btn-dribbble btn-color">Dribbble</button>
                  <button id="not-flickr" type="button" class="btn btn-space btn-social btn-flickr btn-color">flickr</button>
                  <button id="not-linkedin" type="button" class="btn btn-space btn-social btn-linkedin btn-color">LinkedIn</button>
                  <button id="not-youtube" type="button" class="btn btn-space btn-social btn-youtube btn-color">YouTube</button>
                  <button id="not-pinterest" type="button" class="btn btn-space btn-social btn-pinterest btn-color">Pinterest</button>
                  <button id="not-github" type="button" class="btn btn-space btn-social btn-github btn-color">GitHub</button>
                  <button id="not-tumblr" type="button" class="btn btn-space btn-social btn-tumblr btn-color">Tumblr </button>
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <!--colors-->
            <div class="panel panel-default">
              <div class="panel-heading panel-heading-divider">Color States<span class="panel-subtitle">Gritter notifications with template color states</span></div>
              <div class="panel-body">
                <p>You can choose between use the basic, gritter Notification style or our theme based notification, just have fun with them.</p>
                <p class="xs-mt-30 text-center">
            ...
            <!--Positions-->
            <div class="panel panel-default">
              <div class="panel-heading panel-heading-divider">Positions<span class="panel-subtitle">Gritter notifications in different screen positions</span></div>
              <div class="panel-body">
