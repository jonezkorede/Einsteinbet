...
<!-- Mirrored from foxythemes.net/preview/products/maisonnette/pages-invoice.php?theme=blue-sky by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jun 2018 02:56:41 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Invoice | Einsteinbet</title>
                        ...
                        <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item parent open"><a href="#" role="button" aria-expanded="false" class="nav-link"><span class="icon s7-portfolio"></span><span>Pages</span></a>
                                      <ul class="mai-nav-tabs-sub mai-sub-nav nav">
                                                  ...
                                                  <li class="nav-item"><a href="pages-invoice.html" class="nav-link active"><span class="icon s7-wallet"></span><span class="name">Invoice</span></a>
                                                  </li>
        ...
        <div class="row invoice">
          <div class="col-md-3 invoice-aside">
            ...
            <div class="invoice-data">
              <div class="invoice-person"><span class="name">Kristopher Donny</span><span class="position">Developer and Designer</span><span>donny@designer.co</span><span>661 Bubby Street</span><span>United States</span></div>
              <div class="invoice-payment-direction"><i class="icon s7-angle-down-circle"></i></div>
              <div class="invoice-person"><span class="name">Elliot Mark</span><span class="position">CEO at BLX</span><span>ceoblx@company.co</span><span>839 Owagner Drive</span><span>United States</span></div>
