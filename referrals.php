...
<!-- Mirrored from foxythemes.net/preview/products/maisonnette/index.php?theme=blue-sky by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jun 2018 02:55:13 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Referrals | Einsteinbet</title>
    ...
    <nav class="navbar navbar-expand navbar-dark mai-top-header">
      <div class="container"><a href="#" class="navbar-brand"></a>
        ...
        <ul class="nav navbar-nav float-lg-right mai-user-nav">
          <li class="dropdown nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle nav-link"> <img src="assets/img/avatar.jpg"><span class="user-name">Harrison Edema</span><span class="angle-down s7-angle-down"></span></a>
                    ...
                    <nav class="navbar navbar-expand-md">
                      ...
                      <div id="mai-navbar-collapse" class="navbar-collapse collapse mai-nav-tabs">
                        <ul class="nav navbar-nav">
                                                  ...
                                                  <li class="nav-item"><a href="./" class="nav-link active"><span class="icon s7-monitor"></span><span class="name">Dashboard</span></a>
                                                  </li>
                                                  
                                                  <li class="nav-item"><a href="my-predictions.php" class="nav-link active"><span class="icon s7-note"></span><span class="name">My predictions</span></a>
                                                  </li>
                                     
                                                  <li class="nav-item"><a href="plans.php" class="nav-link active"><span class="icon s7-cash"></span><span class="name">My package</span></a>
                                                  </li>
                                    
                                                  <li class="nav-item"><a href="referrals.php" class="nav-link active"><span class="icon s7-users"></span><span class="name">Referrals</span></a>
                                                  </li>
                        </ul>
                      </div>
                    </nav>
          ...
          <div class="col-md-6">
            <div class="widget widget-fullwidth">
              <div class="widget-head">
                <div class="tools"><span class="icon s7-cloud-download"></span><span class="icon s7-refresh-2"></span></div><span class="title">Chart Table</span><span class="description">This is a table widget with a chart inside</span>
              </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody class="no-border-x">
                      <tr>
                        ...
                        <td class="number">14358</td>
                      </tr>
                      <tr>
                        <td>Mac OS</td>
                        <td class="number">286</td>
                        <td class="number">1742</td>
                        <td class="number">13273</td>
                      </tr>
                      <tr>
                        <td>Linux</td>
